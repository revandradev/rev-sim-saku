...
<head>
    ...
    <title>{{ config('app.name', 'Isaku') }}</title>
...
<body>
    <div class="bg-gray-900">
        <header class="absolute inset-x-0 top-0 z-50">
            <nav aria-label="Global" class="flex items-center justify-between p-6 lg:px-8">
                ...
                <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                    <a href="{{ route('filament.user.auth.login') }}" class="text-sm/6 font-semibold text-white">Log in
        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="mx-auto max-w-4xl py-32 sm:py-48 lg:py-30">
                ...
                <div class="text-center">
                    <h1 class="text-5xl font-semibold tracking-tight text-balance text-white sm:text-7xl">
                        Aplikasi Pencatatan Keuangan Sederhana & Praktis
                    </h1>
                    <p class="mt-8 text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">
                        ISaku membantu Anda mencatat pemasukan dan pengeluaran harian dengan mudah, aman, dan efisien.
                        Cocok untuk kebutuhan pribadi maupun usaha kecil.
                    </p>
                    <div class="mt-10 flex items-center justify-center gap-x-6">
                        <a href="#"
                            class="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Mulai
                            Sekarang</a>
                        <a href="#" class="text-sm/6 font-semibold text-white">Pelajari lebih lanjut <span
                                aria-hidden="true">→</span></a>
                    </div>
                </div>
            </div>
            <footer style="text-align: center; padding: 1rem 0;" class="text-gray-400">
                ISaku — aplikasi pencatatan keuangan sederhana, dibuat dengan <span
                    style="color: red;">&#10084;&#65039;</span> oleh revandev
            </footer>
        </div>
    </div>
</body>
